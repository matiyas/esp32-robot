...
#strong[Autor:] Tutorial wygenerowany na podstawie projektu ESP32-CAM
Robot Controller

#strong[Wersja:] 1.0

#strong[Wymagania wstępne:] Podstawowa znajomość języka C (zmienne,
funkcje, pętle, tablice)
...
== CZĘŚĆ I: FUNDAMENTY
<część-i-fundamenty>
- #link(<rozdział-1-zaawansowane-koncepty-języka-c>)[Rozdział 1: Zaawansowane Koncepty Języka C]
- #link(<rozdział-2-wprowadzenie-do-programowania-mikrokontrolerów>)[Rozdział 2: Wprowadzenie do Programowania Mikrokontrolerów]
- #link(<rozdział-3-esp32---architektura-i-ekosystem>)[Rozdział 3: ESP32 - Architektura i Ekosystem]
- #link(<rozdział-4-komponenty-sprzętowe-projektu>)[Rozdział 4: Komponenty Sprzętowe Projektu]

== CZĘŚĆ II: BUDOWA PROJEKTU
<część-ii-budowa-projektu>
- #link(<rozdział-5-struktura-projektu-i-konfiguracja>)[Rozdział 5: Struktura Projektu i Konfiguracja]
- #link(<rozdział-6-komponent-robot_hal---warstwa-abstrakcji-sprzętu>)[Rozdział 6: Komponent robot\_hal - Warstwa Abstrakcji Sprzętu]
- #link(<rozdział-7-komponent-motor_control---sterowanie-silnikami>)[Rozdział 7: Komponent motor\_control - Sterowanie Silnikami]
- #link(<rozdział-8-komponent-servo_control---sterowanie-wieżą>)[Rozdział 8: Komponent servo\_control - Sterowanie Wieżą]
- #link(<rozdział-9-komponent-wifi_manager---zarządzanie-wifi>)[Rozdział 9: Komponent wifi\_manager - Zarządzanie WiFi]
- #link(<rozdział-10-komponent-camera_stream---streaming-mjpeg>)[Rozdział 10: Komponent camera\_stream - Streaming MJPEG]
- #link(<rozdział-11-komponent-safety_handler---bezpieczeństwo>)[Rozdział 11: Komponent safety\_handler - Bezpieczeństwo]
- #link(<rozdział-12-komponent-robot_core---fasada>)[Rozdział 12: Komponent robot\_core - Fasada]

== CZĘŚĆ III: HTTP API
<część-iii-http-api>
- #link(<rozdział-13-komponent-http_server---serwer-rest>)[Rozdział 13: Komponent http\_server - Serwer REST]
- #link(<rozdział-14-api-handlers---endpointy-rest>)[Rozdział 14: API Handlers - Endpointy REST]

== CZĘŚĆ IV: TESTOWANIE I DEPLOYMENT
<część-iv-testowanie-i-deployment>
- #link(<rozdział-15-pisanie-testów-z-unity-framework>)[Rozdział 15: Pisanie Testów z Unity Framework]
- #link(<rozdział-16-budowanie-flashowanie-i-debugging>)[Rozdział 16: Budowanie, Flashowanie i Debugging]
- #link(<rozdział-17-gotowy-projekt-i-dalszy-rozwój>)[Rozdział 17: Gotowy Projekt i Dalszy Rozwój]

== DODATKI
<dodatki>
- #link(<dodatek-a-pełna-lista-referencji-do-dokumentacji>)[Dodatek A: Pełna Lista Referencji do Dokumentacji]
- #link(<dodatek-b-słownik-polsko-angielski>)[Dodatek B: Słownik Polsko-Angielski]
- #link(<dodatek-c-diagram-zależności-komponentów>)[Dodatek C: Diagram Zależności Komponentów]

#horizontalrule

= CZĘŚĆ I: FUNDAMENTY
<część-i-fundamenty-1>
...
= CZĘŚĆ IV: TESTOWANIE I DEPLOYMENT
<część-iv-testowanie-i-deployment-1>
...
= Dodatek A: Pełna Lista Referencji do Dokumentacji
<dodatek-a-pełna-lista-referencji-do-dokumentacji-1>
== ESP-IDF
<esp-idf>
#figure(
  align(center)[#table(
...
= Dodatek B: Słownik Polsko-Angielski
<dodatek-b-słownik-polsko-angielski-1>
#figure(
  align(center)[#table(
    columns: 3,
    align: (auto,auto,auto,),
...
= Dodatek C: Diagram Zależności Komponentów
<dodatek-c-diagram-zależności-komponentów-1>
```mermaid
graph LR
    subgraph "Aplikacja"
        main[main.c]
