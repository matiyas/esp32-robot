...
static esp_err_t init_motors(void)
{
    motor_control_config_t config = {
        .left_motor = {
            .in1 = APP_MOTOR_LEFT_IN1,
            .in2 = APP_MOTOR_LEFT_IN2
        },
        .right_motor = {
            .in1 = APP_MOTOR_RIGHT_IN1,
            .in2 = APP_MOTOR_RIGHT_IN2
        },
...
static esp_err_t init_safety(void)
{
    safety_config_t config = {
        .watchdog_timeout_ms = APP_WATCHDOG_TIMEOUT * 1000,
        .movement_timeout_ms = APP_MOVEMENT_TIMEOUT,
        .turret_timeout_ms = APP_TURRET_TIMEOUT
    };
